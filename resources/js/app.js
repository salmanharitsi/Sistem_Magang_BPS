    ...
    function slider() {
        ...
        function updateSliderWidth(sliceValue) {
            return document.body.clientWidth > 1000 ? sliceValue.slice(0, -2) : sliceValue.slice(0, -2);
        }
        
        function prev() {
            let marginLeft = +updateSliderWidth(slider.style.marginLeft);
            let maxShift = -cardWidth * (cards.length - (document.body.clientWidth > 1000 && document.body.clientWidth < 1600 ? elementToShow + 0.5 : elementToShow));
