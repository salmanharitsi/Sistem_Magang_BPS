<div class="px-2 pb-4">
    <form wire:submit.prevent="submit" class="space-y-8">
        ...
        <div class="bg-white rounded-xl shadow-lg p-5 border-l-4 border-blue-500 transition-all hover:shadow-xl">
        ...
        <div class="bg-white rounded-xl shadow-lg p-5 border-l-4 border-green-500 transition-all hover:shadow-xl">
        ...
        <div class="bg-white rounded-xl shadow-lg p-5 border-l-4 border-amber-500 transition-all hover:shadow-xl">
                ...
                <div class="flex items-center">
                    ...
                    <div class="ml-3">
                        <p class="text-sm text-red-700 font-medium">
                            Masih ada bagian yang belum diisi! Silakan lengkapi semua field yang wajib diisi.
                        </p>
                    </div>
                </div>
            </div>
