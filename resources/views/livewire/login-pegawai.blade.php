<form class="space-y-4 " wire:submit.prevent="login_pegawai">

    <a href=""
        class="flex gap-2 items-center justify-center border-2 border-blue-600 text-blue-700 bg-white hover:bg-blue-600 hover:text-white transition duration-300 ease-in-out focus:ring-2 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5">
        <img class="w-[30px]" src="{{ asset('assets/bps-logo.svg') }}" alt="BPS logo image">
        <p>SSO Badan Pusat Statistik</p>
    </a>

    <div class="flex items-center">
        <hr class="flex-grow border-gray-400">
        <span class="mx-4 text-sm text-gray-500 font-medium">OR</span>
        <hr class="flex-grow border-gray-400">
    </div>
