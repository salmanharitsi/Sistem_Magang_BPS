<div class="pegawai-container">
    <div class="p-4 border-b border-gray-300">
        <h1 class="font-semibold text-lg text-gray-800">Galeri Foto</h1>
    </div>
            ...
            <form class="flex items-center">
                ...
                <div class="relative w-full">
                    ...
                    <input wire:model.live="search" type="text" id="simple-search"
                        ...
                        placeholder="Cari Galeri..." required="">
                </div>
            </form>
        </div>
            ...
            <tbody>
                @forelse ($galeris as $galeri)
                    <tr class="bg-white border-b hover:bg-gray-50">
                        <td class="py-4 px-6 text-left">{{ $galeri->judul }}</td>
                        <td class="py-4 px-6 text-left">
                            <img src="{{ asset('storage/' . $galeri->image_path) }}" alt="Foto" class="w-24 h-16 object-cover rounded">
                        </td>
                        <td class="py-4 px-6">
                            <div class="flex gap-2 w-fit mx-auto items-center">
                                <button wire:click="edit({{ $galeri->id }})" class="mx-auto w-fit flex items-center gap-1 bg-blue-600 border border-transparent px-2 py-2 rounded-lg text-white hover:bg-blue-100 hover:border hover:border-blue-600 hover:text-blue-600 transition-all duration-200">
                                    <i class="ti ti-edit"></i>
                                </button>
                                <button wire:click="confirmDelete({{ $galeri->id }})" class="mx-auto w-fit flex items-center gap-1 bg-red-600 border border-transparent px-2 py-2 rounded-lg text-white hover:bg-red-100 hover:border hover:border-red-600 hover:text-red-600 transition-all duration-200">
                ...
                @empty
                    <tr>
                        <td colspan="3" class="text-center py-10 text-gray-400">
                            ...
                            <p class="font-semibold">Data galeri tidak ditemukan</p>
                        </td>
                    </tr>
                @endforelse
            </tbody>
        </table>
        {{ $galeris->links('vendor.pagination.custom-pagination') }}
    </div>
