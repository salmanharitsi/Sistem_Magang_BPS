<div>
    ...
    <div class="col-span-4 card rounded-lg bg-white p-5 h-full dark:bg-[#14181b] transition-all duration-200">
        <div class="">
            ...
            <h2 class="text-gray-900 text-l dark:text-white">
                27 September 202
            </h2>
            <div
    ...
    <div class="col-span-4 card mt-6 rounded-lg bg-white p-5 h-full dark:bg-[#14181b] transition-all duration-200">
            <div>
                <label class="block mb-2 text-2xl font-semibold">
                    Kegiatan<span
                ...
                <textarea
                    ...
                    required
                >Hari ini saya melanjutkan project yang sudah dikerjakan sebelumnya dan membuat desain website baru</textarea>
            </div> 
            <div>
                <div class="mt-6">
                    <h6 class="text-2xl font-semibold text-gray-800">Lampiran<span
            ...
            <div class="grid grid-cols-2 gap-4">
                <button type="submit"
                    class="w-full text-white mt-6 bg-red-600 hover:bg-red-700 transition duration-300 ease-in-out focus:ring-2 focus:outline-none focus:ring-red-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center disabled:bg-blue-400 disabled:cursor-not-allowed">
                    Tolak Logbook
                </button>
                <button type="submit"
                    class="w-full text-white mt-6 bg-blue-600 hover:bg-blue-700 transition duration-300 ease-in-out focus:ring-2 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center disabled:bg-blue-400 disabled:cursor-not-allowed">
                    Terima Logbook
                </button>
