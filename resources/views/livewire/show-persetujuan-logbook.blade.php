                        ...
                        <td class="py-4 px-6 text-center">
                            <div class="text-[13px] mx-auto items-center w-fit">
                                @if ($data->status == 'mengisi')
                                    <p class="text-xs text-green-700 border-green-600 bg-green-50 border-2 rounded-full whitespace-nowrap px-3 py-1 ">Mengisi</p>
                                @elseif($data->status == 'tidak-mengisi')
                                    <p class="text-xs text-red-700 border-red-600 bg-red-50 border-2 rounded-full whitespace-nowrap px-3 py-1 ">Tidak Mengisi</p>
                                @endif
                            </div>
                        </td>
                        <td class="py-4 px-6">
    ...
    <div class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-[1000]">
        <div class="bg-white rounded-lg shadow-lg w-11/12 md:w-1/2 p-5">
            ...
            <div class="mt-4 flex gap-5">
                <button wire:click="tolakLogbook" class="w-full bg-red-600 text-white px-4 py-2 rounded-lg hover:bg-red-700 transition-all duration-200">
                    Tolak Dokumen
                </button>
                <button wire:click="approveLogbook" class="w-full bg-green-500 text-white px-4 py-2 rounded-lg hover:bg-green-600 transition-all duration-200">
                    Setujui Dokumen
                </button>
            </div>
        </div>
